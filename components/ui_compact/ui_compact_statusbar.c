...
void ui_compact_statusbar_update(lv_obj_t *statusbar, const statusbar_data_t *data) {
    ...
    switch (data->signal_strength) {
        case SIGNAL_STRONG: rf_icon_src = &rf_4_bars; break;
        case SIGNAL_GOOD:   rf_icon_src = &rf_3_bars; break;
        case SIGNAL_FAIR:   rf_icon_src = &rf_2_bars; break;
        case SIGNAL_WEAK:   rf_icon_src = &rf_1_bars; break;
        default:            rf_icon_src = &rf_0_bars; break;
    }
